...
<html lang="en">
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="index.php">Tabaja a tu medida</a></h1>
				<nav id="nav">
					<ul>
		...
		<!-- Banner -->
			<section id="banner">
				<h2>Todo el mundo puede trabajar </h2>
				<p>portal laboral dirigido a todas aquellas personas con necesidades especiales </p>
				<ul class="actions">
					<li>
